...
pbmc3k <- normalizeRnaCounts.se(pbmc3k, size.factors = NULL)

# find highly variable genes
res <- modelGeneVariances(assay(pbmc3k, "logcounts"))
top_hvgs <- chooseHighlyVariableGenes(res$statistics$residuals, top = 2000)

# perform dimensionality reduction
set.seed(100)
pbmc3k <- runPca.se(pbmc3k, features = top_hvgs, number = 30)
...
```{r hvgs}
## Find highly variable genes
res_sketched <- modelGeneVariances(assay(pbmc3k[, pbmc3k$sketched], "logcounts"))
top_hvgs_sketched <- chooseHighlyVariableGenes(res_sketched$statistics$residuals, top = 2000)
length(intersect(top_hvgs, top_hvgs_sketched))
```
